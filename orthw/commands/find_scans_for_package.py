...
class Command(CommandBase):
    ...
    def process(self, package_id: str) -> None:
        ...
        count_sql: str = sql.literal(f"SELECT COUNT(*) FROM scan_results WHERE identifier LIKE '{package_id}'")  # nosec
        ...
        delete_sql: str = f"DELETE FROM scan_results WHERE identifier LIKE {package_id}"  # nosec B608
